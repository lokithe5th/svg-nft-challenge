...
(function() {
	...
	// "On Visible" animations.
		...
		onvisible.add('.buttons.style1', { style: 'fade-down', speed: 750, intensity: 1, delay: 0, stagger: 125, replay: false });
		onvisible.add('h1.style7, h2.style7, h3.style7, p.style7', { style: 'fade-down', speed: 750, intensity: 1, delay: 125, replay: false });
		onvisible.add('.icons.style2', { style: 'fade-up', speed: 500, intensity: 3, delay: 250, replay: false });
